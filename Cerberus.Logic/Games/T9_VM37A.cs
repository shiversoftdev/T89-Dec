...
{
    public partial class T9_VM37AScript : ScriptBase
    {
        /// <summary>
        /// Returns the Game Name for CW
        /// </summary>
        public override string Game => "Cold War VM 37 ALPHA";

        public T9_VM37AScript(Stream stream, Dictionary<uint, string> hashTable, Dictionary<ulong, string> qword_hashTable) : base(stream, hashTable, qword_hashTable) { }
        public T9_VM37AScript(BinaryReader reader, Dictionary<uint, string> hashTable, Dictionary<ulong, string> qword_hashTable) : base(reader, hashTable, qword_hashTable) { }
